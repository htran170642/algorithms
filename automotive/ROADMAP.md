...
| 4 | CAN fundamentals | `av_can`: bit-by-bit arbitration simulator (wired-AND, RTR/SRR/IDE tie-breakers) · `ErrorCounters` active/passive/bus-off + recovery · `can_bus` demo: 6 scenarios, 4 faults | — | [`w04_can.md`](notes/w04_can.md) · [vi](notes/w04_can_vi.md) | [x] |
